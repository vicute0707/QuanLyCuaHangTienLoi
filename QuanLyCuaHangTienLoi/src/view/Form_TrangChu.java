...
public class Form_TrangChu extends JPanel {
	...
	private JPanel createDashboardPanel() {
		...
		mainContent.add(createStatCard("Doanh thu", "12.5M", "↑ 12%", DASHBOARD));
		mainContent.add(createStatCard("Đơn hàng", "254", "↑ 8%", SALES));
		mainContent.add(createStatCard("Khách hàng", "1,254", "↑ 15%", CUSTOMERS));
		mainContent.add(createStatCard("Sản phẩm", "45", "↑ 5%", PRODUCTS));
